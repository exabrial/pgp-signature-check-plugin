...
public class AscArtifactHandler implements ArtifactHandler {
	...
	/**
	 * Initializes a new ASC Artifact Handler to wrap the provided regular artifact
	 * handler.
	 *
	 ...
	 *          An artifact handler that will be wrapped by this ASC Artifact
	 *          Handler, such that all information about the target artifact come
	 *          from the provided handler, except for the file extension (".asc").
	 */
